...
namespace MarsFramework.Pages
{
    internal class ShareSkill
    {
        ...
        //internal void EditShareSkill(string title, string desc, string cat, string subCat, string tag, string serviceType, string location, string skilltrade, string skillExchange, string credit, string active)
        //{
